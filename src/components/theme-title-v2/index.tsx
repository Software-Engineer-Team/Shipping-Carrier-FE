...
import { Typography, theme, Space, Avatar } from 'antd';
import React from 'react';

const { useToken } = theme;

const defaultText = 'Bigsize Ship';
...
export type ThemedTitleV2CustomProps = {
  collapsed?: boolean;
...
export const ThemedTitleV2Custom: React.FC<ThemedTitleV2CustomProps> = ({ collapsed = false, icon = defaultIcon, subTitle = defaultText, title = defaultText, wrapperStyles }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Avatar shape="circle" size={48} src={'/images/logo/bigsizeship_logo_full_white.png'} />
        </div>
