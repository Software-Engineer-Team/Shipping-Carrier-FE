...
import { Card, Col, Form, FormProps, Row, Select, theme } from 'antd';
import React, { useEffect, useState } from 'react';

import { IUser } from '../../../../interfaces/types';
import { APIEndPoint, StringUtils } from '../../../../utils';

export interface ISearchCustomerPrice {
  customer: number;
}
interface ISearchForm {
  searchFormProps: FormProps<ISearchCustomerPrice>;
}
export const SearchForm = (props: ISearchForm) => {
  ...
  return (
    <Card title={translate('orders.titles.filter')} style={{ marginBottom: token.marginLG }}>
